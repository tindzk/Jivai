...
HTTP_Status
	HTTP_Status_Info_Continue = HTTP_Status(
		100, "Continue", "The client should continue with its request"
	),

	HTTP_Status_Info_SwitchingProtocol = HTTP_Status(
		101, "Switching Protocols", "The server is willing "
		"to change the application protocol being used on this connection"
	),

	HTTP_Status_Info_Processing = HTTP_Status(
	...
	HTTP_Status_ClientError_RequestEntityTooLarge = HTTP_Status(
	...
	HTTP_Status_ClientError_RequestUriTooLong = HTTP_Status(
	...
	HTTP_Status_ClientError_UnsupportedMediaType = HTTP_Status(
	...
	HTTP_Status_ClientError_RequestedRangeNotSatisfiable = HTTP_Status(
	...
	HTTP_Status_ClientError_ExpectationFailed = HTTP_Status(
		417, "Expectation Failed", "The expectation "
		"given in the request header could not be met by this server"
	),

	HTTP_Status_ClientError_UnprocessableEntity = HTTP_Status(
	...
	HTTP_Status_ClientErrorLocked = HTTP_Status(
		423, "Locked", "The source or destination resource of "
		"a method is locked"
	),

	HTTP_Status_ClientError_FailedDependency = HTTP_Status(
	...
	HTTP_Status_ServerError_ServiceUnavailable = HTTP_Status(
	...
	HTTP_Status_ServerError_GatewayTimeout = HTTP_Status(
